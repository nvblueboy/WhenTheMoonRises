...
public class ItemShop : MonoBehaviour
{
    ...
    void Awake()
    {
        player = GameObject.Find("Sunny sprite front 128p").GetComponent<PlayerCharacter>();
        ...
        if (Input.GetKeyDown(KeyCode.Space))
        {
            if (arrow1.activeInHierarchy)
            {
                if (coins >= 5)
                {
                    ...
                    player.addItem("small hp potion");
                }
                else
                {
            ...
            else if (arrow2.activeInHierarchy)
            {
                if (coins >= 20)
                {
                    ...
                    coinText.text = coins + " C";
                    player.addItem("medium hp potion");
            ...
            else if (arrow3.activeInHierarchy)
            {
                if (coins >= 50)
                {
                    ...
                    coinText.text = coins + " C";
                    player.addItem("large hp potion");
                }
                else
                {
                    shopText.text = "You don't have enough \n coins to buy that";
            ...
            else if (arrow4.activeInHierarchy)
            {
                if (coins >= 5)
                {
                    ...
                    coinText.text = coins + " C";
                    player.addItem("small stamina potion");
                }
                else
                {
                    shopText.text = "You don't have enough \n coins to buy that";
            ...
            else if (arrow5.activeInHierarchy)
            {
                if (coins >= 20)
                {
                    ...
                    coinText.text = coins + " C";
                    player.addItem("medium stamina potion");
                }
                else
                {
                    shopText.text = "You don't have enough \n coins to buy that";
            ...
            else if (arrow6.activeInHierarchy)
            {
                if (coins >= 50)
                {
                    ...
                    coinText.text = coins + " C";
                    player.addItem("large stamina potion");
                }
                else
                {
                    shopText.text = "You don't have enough \n coins to buy that";
            ...
            else if (arrow10.activeInHierarchy)
            {
                if (coins >= 50)
                {
                    ...
                    coinText.text = coins + " C";
                    player.addItem("mega firework bundle");
                }
                else
                {
                    shopText.text = "You don't have enough \n coins to buy that";
            ...
            {
                SceneManager.LoadScene("Ravens_Ridge");
            }
            item = "";
            for (int i = 0; i < player.inventory.Length; ++i)
            {
